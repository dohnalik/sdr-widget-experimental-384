...
#define EP_OUT_LENGTH_2_HS  400				   // ((384000 + 7999) +1) * stereo * 4bytes
#define EP_OUT_LENGTH_2_FS	400
...
#define EP_INTERVAL_2_HS    0x01			 // One packet per uframe
...
#define FORMAT_BIT_RESOLUTION_1				32	    // 32 bits per sample
